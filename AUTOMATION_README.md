...
- **email**: Email portal (akan replace "kilasjanten33@gmail.com")
- **socialHandle**: Handle social media (akan replace "kilasjanten")
- **colors**: Tema warna
...
| `kilasjanten` | `siteName` (tanpa spaces) |
| `kilasjanten` | `socialHandle` |
| `kilasjanten33@gmail.com` | `email` |

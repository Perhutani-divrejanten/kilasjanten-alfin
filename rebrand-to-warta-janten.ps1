# Rebrand dari Indonesia Daily ke Kilas Janten
...
Write-Log -Message "===== REBRAND Kilas Janten DIMULAI ====="
...
foreach ($file in $htmlFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = "Indonesia Daily"; New = "Kilas Janten" },
            @{ Old = "IndonesiaDaily"; New = "kilasjanten" },
            @{ Old = "indonesiadaily"; New = "kilasjanten" },
            # Social media links
            @{ Old = "https://twitter.com/indonesiadaily"; New = "https://twitter.com/kilasjanten" },
            @{ Old = "https://facebook.com/indonesiadaily"; New = "https://facebook.com/kilasjanten" },
            @{ Old = "https://instagram.com/indonesiadaily"; New = "https://instagram.com/kilasjanten" },
            @{ Old = "https://youtube.com/@indonesiadaily"; New = "https://youtube.com/@kilasjanten" },
            @{ Old = "https://linkedin.com/company/indonesiadaily"; New = "https://linkedin.com/company/kilasjanten" },
            # Email
            @{ Old = "indonesiadaily@gmail.com"; New = "kilasjanten@gmail.com" },
            # Logo references
            @{ Old = 'alt="IndonesiaDaily"'; New = 'alt="kilasjanten"' }
        )
...
foreach ($file in $packageJsonFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = """name"": ""indonesiadaily"""; New = """name"": ""kilasjanten""" },
            @{ Old = """name"": ""indonesiadaily-article-generator"""; New = """name"": ""kilasjanten-article-generator""" }
        )
...
Write-Log -Message ""
Write-Log -Message "Rebrand Kilas Janten selesai ✅"
